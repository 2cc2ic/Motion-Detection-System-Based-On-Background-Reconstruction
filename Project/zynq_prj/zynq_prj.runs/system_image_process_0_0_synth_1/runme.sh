...
HD_PWD='D:/prj/pynq/end/zynq_prj/zynq_prj.runs/system_image_process_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_image_process_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_image_process_0_0.tcl
