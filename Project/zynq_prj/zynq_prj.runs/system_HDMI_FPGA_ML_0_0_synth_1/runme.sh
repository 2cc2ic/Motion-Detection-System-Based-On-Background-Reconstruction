...
HD_PWD='D:/prj/pynq/zynq_prj/zynq_prj.runs/system_HDMI_FPGA_ML_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_HDMI_FPGA_ML_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_HDMI_FPGA_ML_0_0.tcl
