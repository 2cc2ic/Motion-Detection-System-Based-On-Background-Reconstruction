...
HD_PWD='D:/prj/pynq/zynq_prj/zynq_prj.runs/system_OV_Sensor_ML_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_OV_Sensor_ML_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_OV_Sensor_ML_0_2.tcl
