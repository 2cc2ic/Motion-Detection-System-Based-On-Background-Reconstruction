...
--               D:/prj/pynq/zynq_prj/zynq_prj.srcs/sources_1/bd/system/ip/system_OV_Sensor_ML_0_2/system_OV_Sensor_ML_0_2_sim_netlist.vhdl
...
entity system_OV_Sensor_ML_0_2_cmos_decode is
  port (
  ...
  attribute ORIG_REF_NAME of system_OV_Sensor_ML_0_2_cmos_decode : entity is "cmos_decode";
end system_OV_Sensor_ML_0_2_cmos_decode;

architecture STRUCTURE of system_OV_Sensor_ML_0_2_cmos_decode is
  ...
  attribute SOFT_HLUTNM of \rgb565_o[15]_i_2\ : label is "soft_lutpair5";
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_OV_Sensor_ML_0_2_count_reset_v1 is
  port (
    \rst_n_reg_reg[4]\ : out STD_LOGIC;
    CLK_i : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of system_OV_Sensor_ML_0_2_count_reset_v1 : entity is "count_reset_v1";
end system_OV_Sensor_ML_0_2_count_reset_v1;

architecture STRUCTURE of system_OV_Sensor_ML_0_2_count_reset_v1 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_OV_Sensor_ML_0_2_OV_Sensor_ML is
  port (
    rgb_o : out STD_LOGIC_VECTOR ( 15 downto 0 );
    hs_o : out STD_LOGIC;
    vs_o : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of system_OV_Sensor_ML_0_2_OV_Sensor_ML : entity is "OV_Sensor_ML";
end system_OV_Sensor_ML_0_2_OV_Sensor_ML;

architecture STRUCTURE of system_OV_Sensor_ML_0_2_OV_Sensor_ML is
  signal cmos_data_r : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal cmos_href_r : STD_LOGIC;
  signal cmos_vsync_r : STD_LOGIC;
  signal nolabel_line48_n_0 : STD_LOGIC;
begin
...
cmos_decode_u0: entity work.system_OV_Sensor_ML_0_2_cmos_decode
     port map (
      CLK_i => CLK_i,
      D(0) => cmos_vsync_r,
...
nolabel_line48: entity work.system_OV_Sensor_ML_0_2_count_reset_v1
     port map (
      CLK_i => CLK_i,
      \rst_n_reg_reg[4]\ => nolabel_line48_n_0
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
...
entity system_OV_Sensor_ML_0_2 is
  ...
  attribute NotValidForBitStream of system_OV_Sensor_ML_0_2 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of system_OV_Sensor_ML_0_2 : entity is "system_OV_Sensor_ML_0_2,OV_Sensor_ML,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of system_OV_Sensor_ML_0_2 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of system_OV_Sensor_ML_0_2 : entity is "OV_Sensor_ML,Vivado 2017.4";
end system_OV_Sensor_ML_0_2;

architecture STRUCTURE of system_OV_Sensor_ML_0_2 is
...
inst: entity work.system_OV_Sensor_ML_0_2_OV_Sensor_ML
     port map (
      CLK_i => \^clk_i\,
